...
WILLYREX_IMAGES = ["https://cdn.discordapp.com/attachments/711665044009648159/973265541152268308/20220501_121631.jpg", "https://cdn.discordapp.com/attachments/821787696217063455/953767041326809098/unknown.png", "https://cdn.discordapp.com/attachments/821787696217063455/934557388122517605/938433.png"]
...
class MyClient(discord.Client):
    ...
    async def on_message(self, msg:discord.Message):
        ...
        if check_word_exists("boga", msg_lower) or "cwinge" in msg_lower or "joker" in msg_lower:
            output_messages.add("<:christian:894703874663915541>")
        ...
        if check_word_exists("pk", msg_lower) or "dumsleier" in msg_lower or "<@!300439218562531328>" in msg_lower:
            output_messages.add("**Você quis dizer:**\n" + get_random_list_value([
        ...
        if "willy" in msg_lower or check_word_exists("rex", msg_lower):
            ...
            output_messages.add(f"{get_random_list_value(WILLYREX_IMAGES)}")
        ...
        if output_message.replace(" ", "").replace("\n", "") != "":
                await self.send_message(msg.channel.id, output_message)
